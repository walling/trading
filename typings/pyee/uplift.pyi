...
_PROXY_NEW_LISTENER_SETTINGS = dict(forward=(False, True), backward=(True, False), both=(True, True), neither=(False, False))
def uplift(cls, underlying, error_handling=..., proxy_new_listener=..., *args, **kwargs):
